...
<!--==============================content================================-->
            ...
            <center>
              <?php      
                       ...
                       while($var = mysql_fetch_assoc($req))
                                  {
									  ?><b> HOTEL : </b><?php          echo $var['nom_h']  ; ?> <br> <br><?php 
								      ?><b> ADRESSE : </b> <?php          echo $var['adresse_h']  ; ?> <br><br> <?php 
									$hotel = $var['nom_h'] ;
									$prix = $var['prix'] ;
								  }
			  ...
			  if(isset($_POST['submit']))
                   { 
					...
					{    
						...
						$sql = "INSERT INTO `db_pfe`.`reservation` (`id`, `type`, `nom_type`, `id_type`, `nom_client`, `prenom_client`, `email_client`, `tel_client`, `cin_client`, `nb_bebe`, `nb_enfant`, `date`, `nb_nuit`, `chambre`, `prix_final`) VALUES (NULL, 'promotion', '$hotel', '$id', '$x1', '$x2', '$x3', '$x4', '$x5', '$x6', '$x7', '$date', '$x9', '$x10' , '$prix_final');";	
						$req = mysql_query($sql)  ;
						if($req )
  {
	...
	header('Location:confermer_reservation_promo_paypal.php?id_client='.$id_client.'') ;
  ...
  }else
  {
    echo("<center>L' <font color=#FF0000> insertion </font> à échouée</center>") ;
              ...
              Votre Nom : <input type="text" name="nom" value="" id="nom"><span class ="error"></span><br><br>
              ...
              Bébé(s) (0-3 ans Gratuit ) : &nbsp;&nbsp;&nbsp;  Enfant(s)(2-12 ans Gratuit ) : <br> 
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <br><br>
               Votre jour d'arrivée à l'hôte : <input type="text" name="date" id="date" class="tcal" value=""><span class ="error"></span><br><br>
                Le nombre de nuit :  
                  <select name="nb_nuit">
