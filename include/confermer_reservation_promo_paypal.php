    ...
    <section id="content">
        ...
        <div class="wrapper">
          <article class="grid_24"> 
            ...
            <form>
            <input align="right" class="button" type="button" value="Imprimer" onClick="window.print()">
            <input align="right" class="button" type="button" value="Paypal" onClick="" >
            </form>
            <br><br>
            <center>
            <?php      
			 ...
			 include('connect.php');
			 construct() ;
			 $sql = " SELECT * FROM `reservation` WHERE `id` = '$id' AND `type` = 'promotion' ";
			 $req = mysql_query($sql) ;
