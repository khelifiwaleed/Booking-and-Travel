        ...
        <div class="header_box">
          ...
          <nav>
            ...
            <ul class="sf-menu">
                ...
                <li class="current"><a href="voyage.php">Vols</a></li>
...
<!--==============================content================================-->
    <section id="content" class="cont_pad1">
        ...
        <div class="wrapper">
                 ...
                 <article class="grid_6">
                      <div class="offer maxheight">
                        ...
                        <?php echo $result['nom'] ; ?>
                                               ...
                                               <?php
                                               $sql2 = "SELECT * FROM `image` WHERE `select_id` = '$promotion_id' && `type` = \"v\" LIMIT 0 , 1";
           ...
           <a href=\"descriptif_detaille_voyage.php?idnom=".$result['id'] ."\"><font color=#FF0000> Voir le descriptif détaillé </font> </a></div><br>"
       ) ;              ?>
                   </div>    
                </div> 
             </article> 
                                  ...
                                  { 
                                     ...
                                     <?php   
                                               ...
                                               while($var4 = mysql_fetch_assoc($req4))
                                                          {
															?>
															   <figure><a href="descriptif_detaille_promotion.php?idnom=<?php echo $var3['id'] ; ?> " class="img_wrap"> <img height="144" width="202" src="../<?php echo $var4['path'] ; ?>" alt="" /></a></figure>
                                                            <?php 
														  }
											?>
                                             <div> 
											 <p class="f_14"> HOTEL <?php       echo $var3['nom_h'] ;  ?> .</p>
                                             <?php       echo $var3['description'] ;  ?>. <br>
											 <?php       echo $var3['adresse_h'] ;  ?> .
											  <?php       
				    echo(
           "<div align=\"left\">
