        ...
        <div class="header_box">
          ...
          <nav>
            ...
            <ul class="sf-menu">
                ...
                <li class="current"><a href="hotel.php">Notre Hôtel</a></li>
...
<!--==============================content================================-->
    <section id="content" class="cont_pad1">
        ...
        <div class="wrapper">
                 ...
                 <article class="grid_6">
                      <div class="offer maxheight">
                        ...
                        <?php echo $result['nom']; ?>
                                               ...
                                               <?php
                                               $sql2 = "SELECT * FROM `image` WHERE `select_id` = '$m' && `type` = \"h\" LIMIT 0 , 1";
           ...
           <a href=\"descriptif_detaille_hotel.php?idnom=".$result['id'] ."\"><font color=#FF0000> Voir le descriptif détaillé </font> </a></div><br>"
       ) ;              ?>
                   </div>    
                </div> 
             </article> 
       ...
       <br><br>
        ...
        <div class="wrapper">
          <article class="grid_16">
            <h2 class="ind1">nouveau annonce sur des voyage :</h2>
            <ul class="ext_list s_overview">
             
             <?php
             $sql3 = " SELECT * FROM `voyage` ORDER BY `voyage`.`id` DESC LIMIT 0, 2 ";
                                  ...
                                  { 
                                     ...
                                     <?php   
                                               ...
                                               while($var4 = mysql_fetch_assoc($req4))
                                                          {
															?>
															   <figure><a href="descriptif_detaille_voyage.php?idnom=<?php echo $var3['id'] ; ?> " class="img_wrap"> <img height="144" width="202" src="../<?php echo $var4['path'] ; ?>" alt="" /></a></figure>
                                                            <?php 
														  }
											?>
                                             <div> 
											 <p class="f_14"> <?php       echo $var3['nom'] ;  ?> .</p>
